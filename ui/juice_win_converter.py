...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pb_MappsTimeline.setGeometry(QtCore.QRect(620, 60, 101, 31))
        ...
        self.pb_Generate.setGeometry(QtCore.QRect(280, 500, 181, 31))
        self.pb_Generate.setObjectName("pb_Generate")
        self.l_version = QtWidgets.QLabel(Form)
        self.l_version.setGeometry(QtCore.QRect(620, 510, 111, 20))
        ...
        self.comboBox_targetList.setGeometry(QtCore.QRect(350, 290, 151, 31))
        ...
        self.le_ObsDecayTimeMin.setGeometry(QtCore.QRect(430, 340, 71, 31))
        ...
        self.logo.setGeometry(QtCore.QRect(580, 420, 141, 111))
        ...
        self.pb_OutputFolderPath.setGeometry(QtCore.QRect(620, 150, 101, 31))
        self.pb_OutputFolderPath.setObjectName("pb_OutputFolderPath")
        self.le_OutputFolderPath = QtWidgets.QLineEdit(Form)
        self.le_OutputFolderPath.setGeometry(QtCore.QRect(180, 150, 431, 31))
    ...
    def retranslateUi(self, Form):
        ...
        self.le_OutputFolderPath.setText(_translate("Form", " "))
